...
class ClockTime {
  ...
  ClockTime() {
    ...
    hourTens = Digit(
      ...
      timeLeftBeforeDigitUpdate: Duration(
          seconds: COMMOM_DURATIONS['TEN_HOURS'] -
              ...
              now.second),
      initialProgress:
          (60 * 60 * (now.hour % 10) + 60 * now.minute + now.second) /
    ...
    hourOnes = Digit(
      value: now.hour % 10,
      timeLeftBeforeDigitUpdate: Duration(
          seconds: COMMOM_DURATIONS['ONE_HOUR'] - 60 * now.minute - now.second),
      initialProgress:
          (60 * now.minute + now.second) / COMMOM_DURATIONS['ONE_HOUR'],
    );
    ...
    minuteTens = Digit(
      ...
      timeLeftBeforeDigitUpdate: Duration(
          seconds: COMMOM_DURATIONS['TEN_MINUTES'] -
              60 * (now.minute % 10) -
              now.second),
      initialProgress: (60 * (now.minute % 10) + now.second) /
